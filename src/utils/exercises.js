...
export const EXERCISES = [
     ...
     {name:'standing dumbbell incline fly',
        type: 'accessory',
        meta: {
            environment: 'gymhome',
            level: [0, 1, 2],
    ...
    {name:'tbar_row',
     ...
     { name:'chest_supported_dumbbell_row',
        type: 'accessory',
        meta: {
            environment: 'gym',
            level: [0, 1, 2],
     ...
     {name:'seated_dumbbell_overhead_press',
        type: 'compound',
        meta: {
            environment: 'gymhome',
            level: [0, 1, 2],
     ...
     {name:'bentover_dumbbell_push_aparts',
        type: 'accessory',
        meta: {
            environment: 'gymhome',
            level: [0, 1, 2],
     ...
     {name:'chest_supported_dumbbell_face_pulls',
        type: 'accessory',
        meta: {
            environment: 'gymhome',
            level: [0, 1, 2],
     ...
     {name:'chest_supported_barbell_face_pulls',
        type: 'accessory',
        meta: {
            environment: 'gymhome',
            level: [0, 1, 2],
    ...
    {name:' back_squats',
     ...
     {name:'hamstring_back_extensions',
        type: 'accessory',
        meta: {
            environment: 'gym',
            level: [0, 1, 2],
     ...
     {name:'lying_machine_hamstring_curls',
        type: 'accessory',
        meta: {
            environment: 'gym',
            level: [0, 1, 2],
     ...
     {name:'lying_dumbbell_hamstring_curls',
        type: 'accessory',
        meta: {
            environment: 'gymhome',
            level: [0, 1, 2],
    ...
    // },
     ...
     {name:'unilateral_cable_pushdown',
        type: 'accessory',
        meta: {
            environment: 'gymhome',
            level: [0, 1, 2],
